...
for dataset in datasets:
    ...
    for k in range(3, 15):
        for r in range(10, 12):
            print(f"({k}, {r})")
            win_accuracy = engine.win_accuracy(k=k, random_state=r)
            win_accuracies[group_name].append(((k-1)/k, win_accuracy, dataset))

avg_points = {}
for group_name, data in win_accuracies.items():
    grouped_data = {}
...
print("writing...")
fig.write_image("tests/plots/win_accuracy_curve.png", scale=3)
print("wrote!")